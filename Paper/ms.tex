...
\begin{enumerate}
\item Generate $N$ particles $\{\xx_1, ..., \xx_N\}$ from $\pi(\xx)$.\\
\item Calculate the {\it corner count} (Equation~\ref{eqn:corner_count})
of each particle.\\
\end{enumerate}

The corner count of particle $i$ is defined by
\begin{eqnarray}
