...
estimating the partition function of a two-dimensional family of
...
{Z(\beta_1, \beta_2)}
\end{eqnarray}
where $\beta_1$ and $\beta_2$ are two `inverse temperatures'.
...
$L_1$ and $L_2$. The corner count is a related quantity when we have
a collection of $N$ particles in the $L_1$-$L_2$ plane.
