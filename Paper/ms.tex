...
\right].
\end{eqnarray}
The canonical distributions at low temperature for $L_1$ and high temperature
for $L_2$ are gaussians centered at 0.5 with standard deviations
XX. At high temperatures for $L_2$ and low temperatures for $L_1$ the
