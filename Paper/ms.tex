...
of each particle.
\item Choose one of the particles which has corner count equal to the
...
\caption{\it Awesome figure.\label{fig:joint}}
\end{figure}
...
values and doing an NS run with respect to $L_1$ for each.
