...
Consider running standard NS using the objective function $L_1(\xx)$. After some
time, we'd know the function $X(\ell_1) = \int \pi(\xx) \, d\xx$
...
\begin{eqnarray} 
L_2(\xx) &=& -\sum_{i=1}^{100} sin^2(4\pi x)
\right].
\end{eqnarray}
